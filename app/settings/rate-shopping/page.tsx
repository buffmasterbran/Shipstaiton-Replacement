      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <p className="text-sm text-gray-600">
            Map incoming shipping service names (e.g. "UPS Next Day Air Saver") to specific ShipEngine carrier services.
            Matched orders bypass weight-based rules and use the mapped service directly.
          </p>
        </div>
          ...
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <div className="px-6 py-4 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                {/* Carrier Service Picker */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Map To Carrier Service
                  </label>
                  {formServiceCode && (
