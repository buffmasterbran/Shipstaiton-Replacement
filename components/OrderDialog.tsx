...
interface OrderDialogProps {
  ...
  onEdit?: () => void // Callback to open edit dialog
}
...
export default function OrderDialog({ isOpen, onClose, order, rawPayload, onGetRates, onEdit }: OrderDialogProps) {
                ...
                <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-between">
                  <div className="flex gap-2">
                    ...
                    {onEdit && (
                      <button
                        onClick={onEdit}
                        className="flex items-center gap-2 px-3 py-2 text-sm bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium"
                      >
